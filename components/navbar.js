        ...
        <Disclosure>
          {({ open }) => (
            <>
              <div className="flex flex-wrap justify-between md:flex-nowrap md:gap-10">
                ...
                <div className="flex w-full items-center justify-between md:w-auto">
                  ...
                  <Disclosure.Button
                    ...
                    className="ml-auto hidden rounded-md px-2 py-1 text-gray-500 focus:text-blue-500 focus:outline-none dark:text-gray-300 md:hidden "
                  >
                    <svg
              ...
              <Disclosure.Panel>
                <div className="order-2 -ml-4 mt-4 flex hidden w-full flex-col items-center justify-start md:hidden">
